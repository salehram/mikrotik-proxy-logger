...
Public Class PrintClass
    ...
    Dim verticalLocation As Integer = 340 + 50
    ...
    Private Sub PrintDetails(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs, ByVal ReportType As Integer)
        Select Case ReportType
            Case 1 'single user report
                ...
                If rowsCount > 0 Then
                    ...
                    Do
                        With frmViewReport.dgReportMain
                            e.Graphics.DrawString(.Item(1, currentRow).Value, BodyFont, Brushes.Black, New Rectangle(60, verticalLocation, 160, 45))
                            e.Graphics.DrawString(.Item(7, currentRow).Value, BodyFont, Brushes.Black, New Rectangle(220, verticalLocation, 60, 45))
                            e.Graphics.DrawString(.Item(6, currentRow).Value, BodyFont, Brushes.Black, New Rectangle(280, verticalLocation, 520, 45))
                        End With
                        If verticalLocation > 900 Then
                            ...
                            verticalLocation = 40 + 50
                            Exit Do
                        Else
                            e.HasMorePages = False
                        End If
                        currentRow = currentRow + 1
                        verticalLocation = verticalLocation + 50
